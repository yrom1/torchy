...
int main() {
  ...
  std::vector<int> values3 = {1, 2, 3, 4, 5, 6};
  std::vector<int> values4 = {7, 8, 9, 10, 11, 12};
  Tensor<int> t6(dimensions1, values3);
  Tensor<int> t7(dimensions2, values4);
  Tensor<int> t8 = t6.matmul(t7);
